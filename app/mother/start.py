...
async def cb_help(cb: CallbackQuery) -> None:
    ...
    await cb.message.edit_text(
        "ℹ️ <b>راهنما</b>\n\n"
        "🛠 <b>ساخت ربات:</b> روی «🛠 ساخت ربات جدید» بزن، فرم مدرن باز می‌شه؛ "
        "اسم و یوزرنیم ربات رو وارد کن و «Create» رو بزن. بعدش راهنمای ساخت ربات "
        "در @BotFather و گرفتن توکن برات میاد.\n\n"
